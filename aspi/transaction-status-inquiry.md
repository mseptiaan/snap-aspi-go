Transaction Status Inquiry - SNAP Developer Site
...
![](/img/docs/4_24_sequence_diagram_api_transaction_status_inquiry_non_bank.png)

Sequence Diagram API Transaction Status Inquiry

**Informasi Umum**

Service Code53NameAPI Transaction Status InquiryVersion1.0HTTP MethodPOSTPath.../{version}/qr/qr-mpm-status
...
```http
POST .../v1.0/qr/qr-mpm-status HTTP/1.2
